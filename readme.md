...
It will compile `.less` files and package the source into jar. The jar file will be at `target/mytheme.jar`
...
# How to use `mytheme.jar`:

1. Put `mytheme.jar` in `WEB-INF/lib`, then `mytheme.jar`
