...
*/
package org.zkoss.theme.mytheme;
 ...
 * 
 */
public class MythemeThemeWebAppInit implements WebAppInit {

	private final static String THEME_NAME = "mytheme";
	private final static String THEME_DISPLAY = "My theme";
